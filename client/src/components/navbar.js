...
const navigation = [
    ...
    { name: 'Upload Memes', href: '/post-memes', current: false },
];
...
export default function Navbar() {
    ...
    return (
        <Disclosure as="nav" className=" border-b border-skyBlue sticky top-0 z-50 bg-[#7EC2E7]">
                                    ...
                                    return (
                                        <Link
                                            ...
                                            className={classNames(
                                                isCurrent
                                                    ? 'text-darkBlue border border-lightBlue hover:text-[#000]'
                                                    : 'text-darkBlue  hover:text-[#000]',
                ...
                <div className="space-y-1 px-2 pb-3 pt-2">
                    {navigation.map((item) => (
                        <DisclosureButton
                            ...
                            className={classNames(
                                item.current
                                    ? " text-darkBlue border border-lightBlue"
                                    : "text-darkBlue hover:bg- hover:text-lightBlue",
